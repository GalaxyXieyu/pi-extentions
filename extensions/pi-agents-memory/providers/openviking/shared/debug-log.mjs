...
import { sanitizeSensitiveValue } from "../../../core/sensitive.mjs";
...
export function createLogger(hookName, overrideCfg) {
  ...
  function log(stage, data) {
    writeLine(logPath, { ts: localISO(), hook: hookName, stage, data: sanitizeSensitiveValue(data) });
  }
  ...
  function logError(stage, err) {
    const error = err instanceof Error
      ...
      : String(err);
    writeLine(logPath, { ts: localISO(), hook: hookName, stage, error: sanitizeSensitiveValue(error) });
  }
