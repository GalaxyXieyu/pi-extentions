...
```
~/.pi/agent/extensions/pi-viking-memory/
...
Inline in `index.ts`. Loaded from `~/.pi/agent/extensions/pi-viking-memory/config.json`.
...
Tools: viking_search | viking_read | viking_browse | viking_remember | viking_add_resource | viking_archive_expand
```
...
Default: `~/.pi/agent/extensions/pi-viking-memory/config.json`
