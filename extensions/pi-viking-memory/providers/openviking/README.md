...
```bash
node ./extensions/pi-viking-memory/providers/openviking/scripts/setup.mjs
```

`~/.pi/agent/extensions/pi-viking-memory/providers/openviking/config.json` is for behavior knobs only:
